...
if application_insights_connection_string:
    try:
        ...
        logger.warning(
            "Skipping Azure Monitor setup due to invalid APPLICATIONINSIGHTS_CONNECTION_STRING: %s",
            exc
        )
else:
    logger.warning("APPLICATIONINSIGHTS_CONNECTION_STRING not set; Azure Monitor telemetry is disabled.")
